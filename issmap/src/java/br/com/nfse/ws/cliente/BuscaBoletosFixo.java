 ...
 * @author Thiago
 */
public class BuscaBoletosFixo {
    
    public ListaBoletoSF retornaBoletoFixo(String exAno, String mobNro) {
        ...
        try {
            ...
            listaBoletos = service.path("ws").path("bf").path(exAno).path(mobNro).get(ListaBoletoSF.class);
    ...
    public static void main(String args[]) {
        ...
        BuscaBoletosFixo buscaBoleto = new BuscaBoletosFixo();

        ListaBoletoSF listaBoleto = buscaBoleto.retornaBoletoFixo("2012", "197");
